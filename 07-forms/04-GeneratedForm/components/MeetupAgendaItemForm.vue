<template>
  <fieldset class="agenda-item-form">
    ...
    <UiFormGroup v-for="([key, value]) in Object.entries(additionalFields)" :label="value.label">
      <component :is="value.component" v-bind="value.props" v-model="localAgendaItem[key]"/>
    </UiFormGroup>
